...
func _patch(e: Vector4, color: Color, offset: float) -> void:
	...
	if color==Color("4b9390") or color==Color("eedbab"):
		var hazard:=ShaderMaterial.new(); hazard.shader=preload("res://game/hazard.gdshader")
		hazard.set_shader_parameter("water",color==Color("4b9390"))
		hazard.set_shader_parameter("ellipse",e)
		mat=hazard
